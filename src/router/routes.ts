...
const routes: RouteRecordRaw[] = [
  {
    ...
    children: [
      ...
      { path: 'performedTrainings', component: () => import('pages/PerformedTrainingsPage.vue') },
      { path: 'performedTraining', component: () => import('pages/PerformedTrainingPage.vue') },
      { path: 'performedTraining/:id', component: () => import('pages/PerformedTrainingPage.vue') },
