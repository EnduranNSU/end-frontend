...
.bottom-nav {
  ...
  bottom: 0;
  height: 72px;
  background: #3f3b3b; /* тёмно-серый как на макете */
  display: grid;
...
.nav-item {
  display: grid;
  grid-template-rows: 1fr auto; /* иконка занимает всё доступное, текст прижат вниз */
  align-items: center;
  ...
  border: none;
  color: #c8c8c8; /* неактивные иконки и подписи */
  font-size: 12px;
}

.nav-item > .q-icon {
  line-height: 1; /* убираем влияние линии на выравнивание */
}

.nav-item span {
  line-height: 1; /* единый базовый уровень подписи */
  margin-top: 4px;
}

.nav-item.active {
  color: #ffffff; /* активная подсветка */
}
